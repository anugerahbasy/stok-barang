<x-app-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-fit">
            ...
            <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase mb-2">Nama PIC (Kontak Person)</label>
    ...
    @forelse($suppliers as $supplier)
        <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
            ...
            <td class="px-6 py-4 text-sm text-gray-700">{{ $supplier->name }}</td>
