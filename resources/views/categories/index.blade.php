<x-app-layout>
    <x-slot name="title">Manajemen Kategori Barang</x-slot>

    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-fit">
            <h3 class="text-md font-bold text-gray-800 mb-4">Tambah Kategori Baru</h3>
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" required placeholder="Contoh: Elektronik, Sembako" 
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                <h3 class="text-md font-bold text-gray-800">Daftar Kategori Terdaftar</h3>
            </div>
    ...
    @empty
        <tr>
            <td colspan="4" class="px-6 py-10 text-center text-gray-400">Belum ada data kategori.</td>
        </tr>
    @endforelse
</tbody>
        </div>
